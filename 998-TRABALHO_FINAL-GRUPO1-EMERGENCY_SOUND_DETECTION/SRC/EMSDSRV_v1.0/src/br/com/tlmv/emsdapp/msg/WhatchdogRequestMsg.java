...
//	</Params>
//</Request>
public class WhatchdogRequestMsg extends BaseMsg 
{
//Private
...
//Public
	...
	public String replaceTags(String strXml)
	{
		...
		outXml = StringUtil.replaceAll(outXml, AppDefs.FLD_REQMSG_WHATCHDOG_SESSION_UUID, this.getSessionUuid());
		return outXml;
	}
